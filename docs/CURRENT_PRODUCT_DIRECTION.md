...
維持 WPF、四足向量骨架、144 DIP 支撐基準、滑鼠命中區、既有重力與顯示器座標。V0.7 存檔為 schema v3，可讀取遷移 v2；最多 32 筆家具習慣可保存，短期行為、注意力、玩具冷卻與微動作不寫入存檔。桌面圖示互動預設關閉，啟用先備份，提供恢復；不修改原本安全策略。

驗證要區分單元測試、WPF 真實視窗檢查、短時間效能採樣與人工長期體驗。水彩毛流、多螢幕實機驗收、完整家具碰撞體尚未完成，不以向量姿態更新冒充高解析素材工程。

V0.7 Home Update 在原序列、偏好與導航上加入家具語意、紙箱／抓板／睡窩、熟悉度及低頻生活機會。家具沒有貨幣價格、耐久、髒亂或離線懲罰；目標是低壓力陪伴，讓使用者觀察出牠的習慣。
